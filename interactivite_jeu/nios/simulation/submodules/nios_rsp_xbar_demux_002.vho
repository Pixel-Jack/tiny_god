...
--synthesis_resources = 
 ...
 ENTITY  nios_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END nios_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF nios_rsp_xbar_demux_002 IS
