...
--synthesis_resources = 
 ...
 ENTITY  nios_cmd_xbar_demux_001 IS 
	 ...
	 ( 
		 ...
		 sink_valid	:	IN  STD_LOGIC_VECTOR (11 DOWNTO 0);
 ...
 ARCHITECTURE RTL OF nios_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_nios_cmd_xbar_demux_001_wideor0_25_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_nios_cmd_xbar_demux_001_wideor0_25_dataout <= (((((((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0)) OR wire_w_lg_w_sink_channel_range21w22w(0)) OR wire_w_lg_w_sink_channel_range24w25w(0)) OR wire_w_lg_w_sink_channel_range27w28w(0)) OR wire_w_lg_w_sink_channel_range30w31w(0)) OR wire_w_lg_w_sink_channel_range33w34w(0));
	sink_ready <= s_wire_nios_cmd_xbar_demux_001_wideor0_25_dataout;
