...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_002.vho"                                                                -work rsp_xbar_demux_002                                                               
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_switch.vhd"                                                                            -work switch                                                                           
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0.vho"                                                                      -work nios2_qsys_0                                                                     
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_mult_cell.vhd"                                                            -work nios2_qsys_0                                                                     
