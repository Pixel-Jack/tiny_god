...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_bht_ram.dat ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_bht_ram.hex ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_bht_ram.mif ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_dc_tag_ram.dat ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_dc_tag_ram.hex ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_dc_tag_ram.mif ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_ic_tag_ram.dat ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_ic_tag_ram.hex ./
  cp -f $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_ic_tag_ram.mif ./
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_002.vho"                                                                -work rsp_xbar_demux_002                                                                -cdslib ./cds_libs/rsp_xbar_demux_002.cds.lib                                                               
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_id_router_002.vho"                                                                     -work id_router_002                                                                     -cdslib ./cds_libs/id_router_002.cds.lib                                                                    
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_action.vhd"                                                                            -work action                                                                            -cdslib ./cds_libs/action.cds.lib                                                                           
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_buttons.vhd"                                                                           -work buttons                                                                           -cdslib ./cds_libs/buttons.cds.lib                                                                          
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_switch.vhd"                                                                            -work switch                                                                            -cdslib ./cds_libs/switch.cds.lib                                                                           
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0.vho"                                                                      -work nios2_qsys_0                                                                      -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                                     
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_mult_cell.vhd"                                                            -work nios2_qsys_0                                                                      -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                                     
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/nios_switch_s1_translator.vhd"                                                                                                                                                                                                                                                                             
